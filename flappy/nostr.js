 ...
 */
async function publishGameResult(score, gameUrl) {
  const player = NostrPlayer.get();
  if (!player) throw new Error('No player initialized');

  const content = `I scored ${score} in Flappy Bird!

Play here: ${gameUrl}

#FlappyBird #nostr #gaming`;
